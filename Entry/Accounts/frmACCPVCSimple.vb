...
Public Class frmACCPVSimple
   ...
   Private Sub clearHead()
      ...
      lblVID.Text = "0"
        txtVNo.Text = ""
        txtChequeHead.Text = ""
        cmbAccMainHead.SelectedIndex = 0
        txtRefNo.Text = ""
        txtRemarks.Text = ""
    End Sub
   ...
   Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      Try
         ...
         'End If
         Dim strcode As String
         If (txtVNo.Text = "") Or txtVNo.Text Is "" Then
         ...
         If (MID) Then
                ...
                For Each grid As DataGridViewRow In DataGridView1.Rows
                    ...
                    qryMain = "EXEC SpSave_AccVoucherDetailFixed " & grid.Cells("VID").Value & "," & MID & ", " & grid.Cells("AccountID").Value & "," & grid.Cells("AccountTypeID").Value & "," & Setdouble(grid.Cells("Debit").Value) & ",'" & grid.Cells("Narration").Value & "'," & G_CurrencyID & ",0,0,0,0," & G_UID & ",'" & DateTime.Now.ToString("dd/MMM/yyyy") & "','" & G_IPAddress & "'," & G_UID & ",'" & DateTime.Now.ToString("dd/MMM/yyyy") & "','" & G_IPAddress & "' "
   ...
   Private Function verifySave() As String
      ...
      If cmbAccMainHead.SelectedIndex = 0 Then
   ...
   Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click   ''pending
      ...
      If Not txtVNo.Text = "" Then
         ...
         MyListDic.Add("@cWhere", "Where H.VID= " & lblVID.Text & "")
    ...
    Private Sub txtAccHeadDet_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtAccHeadDet.KeyDown
      If e.KeyCode = Keys.F2 Then
         If cmbAccType.SelectedIndex > 0 Then
            ...
            frmLookupCOA.AccTypeID = Setdouble(cmbAccType.SelectedValue.ToString())
            frmLookupCOA.VType = VTYpe
            frmLookupCOA.VCode = ""
            frmLookupCOA.VName = ""
            frmLookupCOA.ShowDialog()
