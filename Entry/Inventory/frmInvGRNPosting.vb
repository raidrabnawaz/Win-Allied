...
Public Class frmInvGRNPosting
   ...
   End Sub
    ...
    Private Sub FillGrid(ByVal strSearch As String)
        ...
        qryMain = "EXEC SPGetGRNPendingPosting @DateFrom='" & CDate(dtpDateFrom.Value).ToString("dd/MMM/yyyy") & "',@DateTo='" & CDate(dtpDateTo.Value).ToString("dd/MMM/yyyy") & "',@VType='" & cmbVType.SelectedIndex & "', @CompanyID=" & G_Compcode & ",@FinancialYearID=" & G_FinancialYearID & ""
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        For Each grid As DataGridViewRow In grdRecord.Rows
            ...
            'End If
            If ispost = 1 Then
                qryMain = "EXEC spSaveGRNPosting " & grid.Cells("VID").Value.ToString & "," & ispost & "," & G_Compcode & "," & G_UID & "," & cmbVType.SelectedIndex & ",'" & CDate(dtpPostingDate.Value).ToString("dd/MMM/yyyy") & "'"
