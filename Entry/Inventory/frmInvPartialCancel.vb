...
Public Class frmInvPartialCancel
   ...
   End Sub
    ...
    Private Sub FillGrid(ByVal strSearch As String)
        ...
        qryMain = "EXEC SpGetInvPendingQty @VType='" & cmbVType.Text & "', @CompanyID=" & G_Compcode & ",@FinancialYearID=" & G_FinancialYearID & ""
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        For Each grid As DataGridViewRow In grdRecord.Rows
            ...
            'End If
            If ispost = 1 Then
                qryMain = "EXEC SPSaveInvPartialCancel " & grid.Cells("VID").Value.ToString & ",'" & grid.Cells("DID").Value.ToString & "','" & cmbVType.Text & "'"
