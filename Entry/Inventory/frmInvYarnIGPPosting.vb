...
Public Class frmInvYarnIGPPosting
    ...
    Private Sub FillGrid(ByVal strSearch As String)
        ...
        qryMain = "EXEC SPGetKnitYarnOGPPendingPosting @DateFrom='" & CDate(dtpDateFrom.Value).ToString("dd/MMM/yyyy") & "',@DateTo='" & CDate(dtpDateTo.Value).ToString("dd/MMM/yyyy") & "',@VNo='" & txtVNo.Text & "', @CompanyID=" & G_Compcode & ",@FinancialYearID=" & G_FinancialYearID & ""
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        For Each grid As DataGridViewRow In grdRecord.Rows
            ...
            If Not IsDBNull(grid.Cells("IsPosted").Value) Then
                ...
                'End If
                If ispost = 1 Then
                    qryMain = "EXEC SPSaveKnitYarnOGPPosting " & grid.Cells("VID").Value.ToString & " ," & ispost & " ," & G_UID & " ,'" & CDate(dtpPostingDate.Value).ToString("dd/MMM/yyyy") & "' "
