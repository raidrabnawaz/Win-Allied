...
Public Class frmInvYarnOGP
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        Try
            ...
            qryMain = "EXEC SpSaveKnitYarnOGPMain " & lblVID.Text & ", '', " & cmbSupplierCode.SelectedValue & ", '" & CDate(dtpVDate.Value).ToString("dd/MMM/yyyy") & "', '" & txtNarration.Text
            ...
            For Each grid As DataGridViewRow In DataGridView1.Rows
                If Setdouble(grid.Cells("Quantity").Value) > 0 Then
                    qryMain = "EXEC SpSaveKnitYarnOGPdetail " & grid.Cells("VID").Value & ", " & MID & ", '" & grid.Cells("ProductID").Value & "','" & grid.Cells("UomID").Value & "',  " & grid.Cells("Quantity").Value & ", " & grid.Cells("Weight").Value & ", '-'," & G_Compcode & "," & G_FinancialYearID & ",'" & grid.Cells("VType").Value & "', " & grid.Cells("VTypePk").Value & ",  " & G_UID & ", '" & G_IPAddress & "', " & G_UID & ",'" & G_IPAddress & "', " & IIf(grid.Cells("IsDel").Value = Nothing, 0, 1)
    ...
    Private Function verifySave() As String
        ...
        End If
        Dim Lock As String
        Lock = objCommon.ExecuteScalar("select dbo.fnAllowBackDate('Win-ERP','frmInvYarnOGP','" & CDate(dtpVDate.Value).ToString("dd/MMM/yyyy") & "'," & G_UID & "," & G_Compcode & ", " & G_FinancialYearID & ")")
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        qryMain = "EXEC SpGetInvSearchLookUp 'OGPYarn', @CWhere='" & cWhere & "' "
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click   ''pending
        MyListDic.Clear()
        rpt = (WinReportsApplication.Classess.InventoryReport.SetReportName("rfYarnOGP"))
        FilterVTypeList = ""
        FilterDate = ""
        ReportTitle = ""

        MyListDic.Add("@VID", lblVID.Text)
        ReportSpName = "SpRptKnitYarnOGP"
    ...
    Private Sub txtAccountCode_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtVCode.KeyDown
        If e.KeyCode = Keys.F2 Then
            frmLookup.LookupQuery = "SELECT VID, VCode, VName, IsAccessory, LeadTime, ExcessPer FROM invProduct where CategoryID=2002"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If Setdouble(txtQuantity.Text) > Setdouble(txtAvailableQty.Text) Then
            MessageBox.Show("Quantity cannot be greater than Available Quantity", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txtQuantity.Focus()
        End If
    ...
    Private Sub GrdAtt_CellClick(ByVal sender As Object, ByVal e As DataGridViewCellEventArgs) Handles grdAtt.CellClick
        If grdAtt.Rows.Count > 0 Then
            If grdAtt.RowCount > -1 Then
                ...
                dt = objCommon.GetDataTable("EXEC SpGetbyIDKnitYarnOGP " & Setdouble(lblVID.Text))
