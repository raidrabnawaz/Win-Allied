Public Class frmSupplierDebitCreditNotes
    ...
    Private Sub txtCreditAmount_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtAmount.KeyPress
        Dim dotLength As Integer = 1
        dotLength = Me.txtAmount.Text.Split("."c).Length
    ...
    Private Sub txtTax_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtTax.KeyPress
        Dim dotLength As Integer = 1
        dotLength = Me.txtTax.Text.Split("."c).Length
        If e.KeyChar <> ControlChars.Back Then
            If dotLength > 1 Then
                e.Handled = Not (Char.IsDigit(e.KeyChar))
            Else
