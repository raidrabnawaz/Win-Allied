Public Class frmProdCutting
   ...
   Private Sub FillGrid()
      ...
      FillHeader()
      qryMain = "EXEC SpGet_ProdCutting " & cmbSaleOrder.SelectedValue.ToString & ""
   ...
   Private Sub FillForm()
      ...
      If txtID.Text = "" Then
         ...
         Return
      End If
      qryMain = "EXEC SpGetbyID_ProdCutting'" & txtID.Text & "' "
      Dim dt As DataTable = objCommon.GetDataTable(qryMain)
      If IsNothing(dt) Then
         'EmptyFields()
         Return
   ...
   Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
      ...
      If txtSrlNo.Text = "" Then
         txtSrlNo.Text = 0
      End If
      qryMain = "EXEC SpSave_ProdCutting " & txtID.Text & "," & txtSrlNo.Text & ", '001' ,'" & CDate(dtpVdate.Value).ToString("dd/MMM/yyyy") & "'," & cmbSaleOrder.SelectedValue & "," & cmbSizes.SelectedValue & "," & txtSizeQty.Text & "," & txtQty.Text & "," & G_Compcode & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
   ...
   Private Sub cmbSizes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSizes.SelectedIndexChanged
      If cmbSizes.SelectedIndex > 0 Then
         qry = "EXEC SpGet_ProdSaleOrderSizeQty  " & cmbSizes.SelectedValue.ToString & "," & cmbSaleOrder.SelectedValue.ToString & ""
