Public Class frmProdFinishing
   Dim qryMain As String
   Dim qry As String
   Dim objCommon As New clsCommon
   Private Sub ProdFinishing_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
   ...
   Private Sub FillGrid()
      ...
      FillHeader()
      qryMain = "EXEC SpGet_ProdFinishing  " & cmbSaleOrder.SelectedValue.ToString & ""
   ...
   Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
      ...
      If txtSrlNo.Text = "" Then
         txtSrlNo.Text = 0
      End If
      qryMain = "EXEC SpSave_ProdFinishing " & txtID.Text & "," & txtSrlNo.Text & ", '001' ,'" & CDate(dtpVdate.Value).ToString("dd/MMM/yyyy") & "'," & cmbSaleOrder.SelectedValue & "," & cmbSizes.SelectedValue & "," & txtSizeQty.Text & "," & txtQty.Text & "," & G_Compcode & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
   ...
   Private Sub FillForm()
      ...
      If txtID.Text = "" Then
         ...
         Return
      End If
      qryMain = "EXEC SpGetbyID_ProdFinishing'" & txtID.Text & "' "
      Dim dt As DataTable = objCommon.GetDataTable(qryMain)
      If IsNothing(dt) Then
         'EmptyFields()
         Return
   ...
   Private Sub cmbSizes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSizes.SelectedIndexChanged
      If cmbSizes.SelectedIndex > 0 Then
         qry = "EXEC SpGet_ProdStitchingSizeQty  " & cmbSizes.SelectedValue.ToString & "," & cmbSaleOrder.SelectedValue.ToString & ""
