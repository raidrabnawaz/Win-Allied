Public Class frmProdStitching
   Dim qryMain As String
   Dim qry As String
   Dim objCommon As New clsCommon
   Private Sub ProdStitching_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
   ...
   Private Sub FillGrid()
      ...
      FillHeader()
      qryMain = "EXEC SpGet_ProdStitching " & cmbSaleOrder.SelectedValue.ToString & ""
   ...
   Private Sub FillForm()
      ...
      If txtID.Text = "" Then
         ...
         Return
      End If
      qryMain = "EXEC SpGetbyID_ProdStitching'" & txtID.Text & "' "
      Dim dt As DataTable = objCommon.GetDataTable(qryMain)
      If IsNothing(dt) Then
         'EmptyFields()
         Return
   ...
   Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
      ...
      If txtSrlNo.Text = "" Then
         txtSrlNo.Text = 0
      End If
      qryMain = "EXEC SpSave_ProdStitching " & txtID.Text & "," & txtSrlNo.Text & ", '001' ,'" & CDate(dtpVdate.Value).ToString("dd/MMM/yyyy") & "'," & cmbSaleOrder.SelectedValue & "," & cmbSizes.SelectedValue & "," & txtSizeQty.Text & "," & txtQty.Text & "," & G_Compcode & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
