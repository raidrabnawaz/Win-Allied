Public Class frmProdWagesEntryEdit
   ...
   Private Sub FillGridSaleOrderOperation()
      grdRecord.Rows.Clear()
      qryMain = "EXEC SpGet_ProdWagesEntryforEdit " & cmbSaleOrder.SelectedValue.ToString & " "
      ...
      For I As Integer = 0 To dt.Rows.Count - 1
         Dim row As String() = New String() {dt.Rows(I)("VID"), dt.Rows(I)("SrlNo"), dt.Rows(I)("OrderID"), dt.Rows(I)("OperationID"), dt.Rows(I)("OperationName"), dt.Rows(I)("OperationPCs"), dt.Rows(I)("VRate"), dt.Rows(I)("EmployeeID"), dt.Rows(I)("EmployeeCode"), dt.Rows(I)("Quantity"), dt.Rows(I)("EmployeeName"), dt.Rows(I)("Quantity") * dt.Rows(I)("VRate")}
