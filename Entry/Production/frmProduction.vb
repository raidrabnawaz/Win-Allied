Public Class frmProduction
    ...
    Private Sub FillGrid()
        ...
        qryMain = "EXEC SpGet_ProdProduction " & cmbSaleOrder.SelectedValue.ToString & ", " & cmbFormType.SelectedValue.ToString & ""
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetbyID_ProdProduction'" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        If txtSrlNo.Text = "" Then
            txtSrlNo.Text = 0
        End If
        qryMain = "EXEC SpSave_ProdProduction " & txtID.Text & "," & txtSrlNo.Text & ", '001' ,'" & CDate(dtpVdate.Value).ToString("dd/MMM/yyyy") & "'," & cmbSaleOrder.SelectedValue & "," & cmbFormType.SelectedValue & ", 0 ," & txtSizeQty.Text & "," & txtQty.Text & "," & G_Compcode & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
