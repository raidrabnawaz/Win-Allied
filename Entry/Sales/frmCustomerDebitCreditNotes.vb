Public Class frmCustomerDebitCreditNotes
    ...
    Private Sub frmAttCode_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        objCommon.FillPayDocType(Me.cmbDocType, "Customer")
        objCommon.FillPayVoucherType(Me.cmbVType, "DrCr")
    ...
    Private Sub ClearHead(ByVal myid As String)
        ...
        cmbSaleInvoiceNo.SelectedValue = 0
    ...
    Private Sub FillHeader()
        ...
        grdcol4.DataPropertyName = "VType"
        grdcol4.HeaderText = "Voucher Type"
        ...
        grdcol6.DataPropertyName = "SalesTax"
        grdcol6.HeaderText = "Tax Amount"
        grdcol6.Name = "grdcol6"
        grdcol6.Width = 100

        grdcol7.DataPropertyName = "NetAmount"
        grdcol7.HeaderText = "Net Amount"
        grdcol7.Name = "grdcol7"
        grdcol7.Width = 100

        grdcol8.DataPropertyName = "VName"
        grdcol8.HeaderText = "Description"
        grdcol8.Name = "grdcol8"
        grdcol8.Width = 200
        '


        grdcol9.DataPropertyName = "VStatus"
        ...
        grdcol10.DataPropertyName = "CompanyID"
        grdcol10.HeaderText = "VID"
        grdcol10.Name = "grdcol10"
        grdcol10.Visible = False
        '

        grdcol11.DataPropertyName = "CurrencyName"
        grdcol11.HeaderText = "VID"
    ...
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
        qryMain = "EXEC SpGetbyShow_invSupplierDebitCreditNotes " & G_Compcode & ",'" & VVtype & "'"
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetbyID_invSupplierDebitCreditNotes " & txtID.Text & ", '" & VVtype & "', " & G_Compcode & " "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
        ...
        cmbCustomer.SelectedValue = dr("VendorID")
        ...
        cmbSaleInvoiceNo.SelectedValue = dr("POID")
        cmbVType.SelectedValue = dr("VType")
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If cmbSaleInvoiceNo.SelectedValue < 0 Then
            MessageBox.Show("Select Sale Invoice No.")
            cmbSaleInvoiceNo.Focus()
            Return
        End If

        If cmbVType.SelectedIndex = 0 Then
            MessageBox.Show("Select Valid Voucher Type.")
            cmbVType.Focus()
            Return
        End If
        ...
        Try
            ...
            qryMain = "EXEC SpSave_invSupplierDebitCreditNotes " & txtID.Text & ",'" & txtVCode.Text & "', '" & CDate(dtpVDate.Value).ToString("dd/MMM/yyyy") & "','" & txtNarration.Text & "'," & cmbCustomer.SelectedValue & ",'" & txtRefNo.Text & "'," & Setdouble(txtAmount.Text) & "," & Setdouble(txtTax.Text) & "," & Setdouble(txtIncomeTaxAmount.Text) & "," & cmbBank.SelectedValue & "," & Setdouble(txtNetAmount.Text) & ",'" & txtChequeNo.Text & "', '" & CDate(dtpChequeDate.Value).ToString("dd/MMM/yyyy") & "'," & G_CurrencyID & "," & IIf(cmbCurrency.SelectedValue = G_CurrencyID, 0, cmbCurrency.SelectedValue) & "," & IIf(cmbCurrency.SelectedValue = G_CurrencyID, 1, Setdouble(txtExchangeRate.Text)) & ",0,0,'" & cmbVType.SelectedValue & "','" & VVtype & "',0," & cmbSaleInvoiceNo.SelectedValue & ",'" & cmbDocType.SelectedValue & "',0," & G_Compcode & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
    ...
    Private Sub cmbSupplier_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCustomer.SelectedIndexChanged
        If cmbCustomer.SelectedIndex = Nothing Then
            Return
        End If
        objCommon.FillInvoiceNo(Me.cmbSaleInvoiceNo, Me.cmbCustomer.SelectedValue)
