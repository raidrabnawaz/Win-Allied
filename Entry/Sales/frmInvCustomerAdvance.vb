Public Class frmInvCustomerAdvance
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If cmbSaleInvoiceNo.SelectedValue < 0 Then
            MessageBox.Show("Select Valid Sale Invoice No.")
    ...
    Private Sub txtIncomeTaxAmount_TextChanged(sender As Object, e As EventArgs) Handles txtIncomeTaxAmount.TextChanged
        ...
        If txtIncomeTaxAmount.Text IsNot "" Then
            TaxAmount = Decimal.Parse(txtIncomeTaxAmount.Text)
        End If
