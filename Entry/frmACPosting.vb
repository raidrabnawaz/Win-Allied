Public Class frmACPosting
    ...
    Private Sub FillHeader()
        ...
        grdcol0.HeaderText = "Delivery No"
        ...
        grdcol2.HeaderText = "Section Code"
        ...
        grdcol3.HeaderText = "Section Name"
        ...
        grdcol5.HeaderText = "Post Status"
    ...
    Private Sub FillForm()
        ...
        txtID.Text = dr("VNo")
        dtpMDNDate.Value = dr("VDate")
        'txtMDNRefNo.Text = dr("ChequeNo")
    End Sub
