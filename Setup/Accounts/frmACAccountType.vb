Public Class frmACAccountType
   ...
   End Sub
    ...
    Private Sub FillHeader()
        ...
        grdcol0.DataPropertyName = "VAbbr"
        ...
        grdcol2.DataPropertyName = "VID"
        grdcol2.HeaderText = "VID"
        grdcol2.Name = "VID"
    ...
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
        qryMain = "EXEC SpGet_AccAccountType"
    ...
    Private Sub FillForm()
        ...
        qryMain = "EXEC SpGetbyID_AccAccountType'" & lblVID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If txtID.Text = "" Then
            MessageBox.Show("Please give some Account Abbr.", G_APP_TITLE)
            txtID.Focus()
            Return
        End If
        txtVName.Text = txtVName.Text.Trim.Replace("'", "")
        ...
        Else
            Active = 0
        End If
      qryMain = "EXEC SpSave_AccAccountType " & lblVID.Text & ",'" & txtID.Text & "','" & txtVName.Text & "'," & G_Compcode & "," & G_FinancialYearID & "," & Active & ",'',0,'','',0,''"
