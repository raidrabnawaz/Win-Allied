Public Class frmACEERType
   ...
   End Sub
    ...
    Private Sub FillForm()
        ...
        qryMain = "EXEC SpGetbyID_EERType'" & lblVID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If txtID.Text = "" Then
            MessageBox.Show("Please give some Abbreviation.", G_APP_TITLE)
            txtID.Focus()
            Return
        End If
        txtVName.Text = txtVName.Text.Trim.Replace("'", "")
        ...
        Else
            Active = 0
        End If
        qryMain = "EXEC SpSave_EERType " & lblVID.Text & ",'" & txtID.Text & "','" & txtVName.Text & "'," & Active & "," & G_Compcode & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
