Public Class frmGPProductCategory
   ...
   End Sub
    ...
    Private Sub FillHeader()
        ...
        grdcol2.HeaderText = "Product Category"
        grdcol2.Name = "grdcol2"
        grdcol2.Width = 400

        grdcol3.DataPropertyName = "CompanyID"
        grdcol3.HeaderText = "CompanyID"
        grdcol3.Name = "grdcol3"
        grdcol3.Visible = False

        grdcol4.DataPropertyName = "FinancialYearID"
        grdcol4.HeaderText = "FinancialYearID"
    ...
    Private Sub FillForm()
        ...
        If lblVID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetbyID_GPProductCategory'" & lblVID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      ...
      txtVName.Text = txtVName.Text.Trim.Replace("'", "")
        ...
        qryMain = "EXEC SpSave_GPProductCategory " & lblVID.Text & ",'" & txtID.Text & "', '" & txtVName.Text & "'," & IsActive.CheckState & "," & G_Compcode & "," & G_FinancialYearID & "," & G_UID & ",'" & G_IPAddress & "'"
