Public Class frmInvVoucherType
   ...
   End Sub
    ...
    Private Sub FillHeader()
        ...
        grdcol1.HeaderText = "Voucher Code"
        ...
        grdcol4.DataPropertyName = "IsDrCr"
        grdcol4.HeaderText = "Is DrCr"
        grdcol4.Name = "grdcol4"
        grdcol4.Visible = False

        Me.grdRecord.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {grdcol0, grdcol1, grdcol2, grdcol3, grdcol4})
    End Sub
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
        qryMain = "EXEC SpGet_AccVoucherTypeJV"
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetbyID_AccvoucherTypeJV '" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      ...
      qryMain = "EXEC SpGetAlreadyExit_AccVoucherTypeJV '" & txtID.Text & "','" & txtVType.Text & "'; "
      qryMain = objCommon.ExecuteScalar(qryMain)
      If qryMain > 0 Then
         MessageBox.Show("Record already exists.", G_APP_TITLE)
         Return
      End If
      txtVType.Text = txtVType.Text.Trim.Replace("'", "")
        If txtVType.Text = "" Then
            MessageBox.Show("Please give some Voucher Type.", G_APP_TITLE)
            txtVType.Focus()
            Return
        End If
        If txtVName.Text = "" Then
            MessageBox.Show("Please give some Voucher Description.", G_APP_TITLE)
            txtVName.Focus()
            Return
        End If
      ...
      qryMain = "EXEC SpSave_AccvoucherTypeJV " & txtID.Text & ", '" & txtVType.Text & "', '" & txtVName.Text & "'," & Active & ",1," & G_Compcode & "," & G_FinancialYearID & "," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
