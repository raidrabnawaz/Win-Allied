Public Class ProdBuyer
   ...
   End Sub
    ...
    Private Sub FillDropDown()
        txtVCode.Text = objCommon.ExecuteScalar("EXEC SpGetVCode_ProdBuyer " & G_Compcode)
   ...
   End Sub
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetbyIDProBuyer'" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If txtID.Text Is "" or txtID.Text = "" Then 'update
            txtID.Text = 0
            txtVCode.Text = objCommon.ExecuteScalar("EXEC SpGetVCode_ProdBuyer " & G_Compcode)        '    qryMain = " update tblAcSetupCOAL1 set VName='" & txtVName.Text & "',GID='" & cmbGroup.SelectedValue & "' where L1Code = '" & txtID.Text & "'; "
        ...
        qryMain = "EXEC SpSave_ProdBuyer " & txtID.Text & ",'" & txtVCode.Text & "', '" & txtVName.Text & "','" & txtEmail.Text & "','" & txtPhone.Text & "','" & txtVatNo.Text & "','" & txtContactPerson.Text & "'," & cmbPaymentTerm.SelectedValue &
