Public Class ProdHalls
    ...
    Private Sub FillGrid()
        ...
        qryMain = "EXEC SpGet_FillGrid_ProdHalls"
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If txtVName.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetAlreadyExit_ProdHalls '" & txtID.Text & "','" & txtVCode.Text & "'; "
        ...
        qryMain = "EXEC SpSave_ProdHalls " & txtID.Text & "," & txtVCode.Text & ", '" & txtVName.Text & "'," & G_Compcode & "," & G_Compcode & "," & IsActive.CheckState & ",''," & G_UID & ",'" & G_IPAddress & "',''," & G_UID & ",'" & G_IPAddress & "'"
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGet_ProdHalls '" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
