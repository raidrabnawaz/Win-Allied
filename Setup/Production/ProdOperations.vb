Public Class ProdOperations
   ...
   Private Sub FillHeader()
      ...
      grdcol2.HeaderText = "Operation Name"
      grdcol2.Name = "grdcol2"
      grdcol2.Width = 400


      grdcol3.DataPropertyName = "VRate"
      grdcol3.HeaderText = "Rate"
      grdcol3.Name = "grdcol3"
      grdcol3.Width = 100


      grdcol4.DataPropertyName = "IsActive"
      grdcol4.HeaderText = "Is Active"
   ...
   Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
        qryMain = "EXEC SpGet_FillGrid_ProdOperation"
   ...
   Private Sub FillForm()
      ...
      If txtID.Text = "" Then
         ...
         Return
      End If
      qryMain = "EXEC SpGetbyID_ProdOperation '" & txtID.Text & "' "
      Dim dt As DataTable = objCommon.GetDataTable(qryMain)
      If IsNothing(dt) Then
         'EmptyFields()
         Return
   ...
   Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      ...
      txtVName.Text = txtVName.Text.Trim.Replace("'", "")
        ...
        If cmbCategory.SelectedIndex <= 0 Then
            MessageBox.Show("Please select Category.", G_APP_TITLE)
            cmbCategory.Focus()
            Return
        End If
        If txtVRate.Text = "" Then
            MessageBox.Show("Please give some Rate.", G_APP_TITLE)
            txtVRate.Focus()
            Return
        End If
      ...
      End If                   '    objCommon.ExecuteNonQuery(qryMain)
        ...
        qryMain = "EXEC SpSave_ProdOperation " & txtID.Text & "," & cmbCategory.SelectedValue & "," & txtVCode.Text & ", '" & txtVName.Text & "'," & txtVRate.Text & "," & chkIsSpecial.CheckState & "," & G_Compcode & "," & G_Compcode & "," & IsActive.CheckState & ",''," & G_UID & ",'" & G_IPAddress & "',''," & G_UID & ",'" & G_IPAddress & "'"
