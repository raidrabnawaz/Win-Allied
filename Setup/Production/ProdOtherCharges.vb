Public Class ProdOtherCharges
    ...
    Private Sub FillGrid()
        ...
        qryMain = "EXEC SpGet_FillGrid_ProdOtherCharges"
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If txtVName.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetAlreadyExit_ProdOtherCharges '" & txtID.Text & "','" & txtVCode.Text & "'; "
        ...
        qryMain = "EXEC SpSave_ProdOtherCharges " & txtID.Text & ",'" & txtVCode.Text & "', '" & txtVName.Text & "'," & IsActive.CheckState & ",0,0," & G_UID & ",'" & G_IPAddress & "'," & G_UID & ",'" & G_IPAddress & "'"
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGet_ProdOtherCharges '" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
