Public Class ProdShipMehtod
   ...
   End Sub
    ...
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
        qryMain = "EXEC SpGet_FillGrid_ProdShippingMethod"
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGet_ProdShippingMethod '" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If txtVName.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetAlreadyExit_ProdShippingMethod '" & txtID.Text & "','" & txtVCode.Text & "'; "
        ...
        qryMain = "EXEC SpSave_ProdShippingMethod " & txtID.Text & "," & txtVCode.Text & ", '" & txtVName.Text & "'," & G_Compcode & "," & G_Compcode & "," & IsActive.CheckState & ",''," & G_UID & ",'" & G_IPAddress & "',''," & G_UID & ",'" & G_IPAddress & "'"
