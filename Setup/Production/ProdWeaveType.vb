Public Class ProdWeaveType
   ...
   End Sub
    ...
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
        qryMain = "EXEC SpGet_FillGrid_ProdWaveType"
    ...
    Private Sub FillForm()
        ...
        If txtID.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGet_ProdWaveType '" & txtID.Text & "' "
        Dim dt As DataTable = objCommon.GetDataTable(qryMain)
        If IsNothing(dt) Then
            'EmptyFields()
            Return
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      ...
      txtVName.Text = txtVName.Text.Trim.Replace("'", "")
        ...
        If txtVName.Text = "" Then
            ...
            Return
        End If
        qryMain = "EXEC SpGetAlreadyExit_ProdWaveType '" & txtID.Text & "','" & txtVCode.Text & "'; "
        ...
        qryMain = "EXEC SpSave_ProdWaveType " & txtID.Text & "," & txtVCode.Text & ", '" & txtVName.Text & "'," & IsActive.CheckState & ",''," & G_UID & ",'" & G_IPAddress & "',''," & G_UID & ",'" & G_IPAddress & "'"
