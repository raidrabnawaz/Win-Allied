Public Class frmCustomer
   ...
   End Sub
    ...
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
      qryMain = " SELECT VID, VName From tblSetupCustomer WHERE Isactive = 1 ORDER BY VName "
    ...
    Private Sub FillForm()
        ...
        If Setdouble(txtID.Text) <= 0 Then
            ...
            Return
        End If
      qryMain = " SELECT top 1 VName From tblSetupCustomer WHERE VID=" & Setdouble(txtID.Text) & ""
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      ...
      txtID.Text = Setdouble(txtID.Text.Trim)
        If txtGroup.Text = "" Then
            ...
            Return
        End If
      qryMain = " Select top 1 VID from tblSetupCustomer where VID <>'" & txtID.Text & "' and VName='" & txtGroup.Text & "' "
        ...
        If Setint(txtID.Text) > 0 Then 'update
         qryMain = " update tblSetupCustomer set VName='" & txtGroup.Text & "',UID=" & G_UID & ",Tranzdatetime=getdate() where VID = " & Setint(txtID.Text)
            objCommon.ExecuteNonQuery(qryMain)
        Else
         qryMain = "insert into tblSetupCustomer (VName, Isactive, UID, Tranzdatetime, CompCode) values('" & _
