Public Class frmProduct
   ...
   End Sub
    ...
    Private Sub FillGrid()
        'grdRecord.DataSource = Nothing
      qryMain = " SELECT VID, VName From tblSetupProduct ORDER BY VName "
   ...
   Private Sub FillForm()
      ...
      If Setdouble(txtID.Text) <= 0 Then
         ...
         Return
      End If
      qryMain = " SELECT top 1 VName From tblSetupProduct WHERE VID=" & Setdouble(txtID.Text) & ""
   ...
   Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
      ...
      If Setint(txtID.Text) > 0 Then 'update
         qryMain = " update tblSetupProduct set VName='" & txtGroup.Text & "',UID=" & G_UID & ",Tranzdatetime=getdate() where VID = " & Setint(txtID.Text)
         objCommon.ExecuteNonQuery(qryMain)
      Else
         qryMain = "insert into tblSetupProduct (VName, VType, UID, Tranzdatetime, CompCode) values('" & _
         txtGroup.Text & "', '', " & G_UID & ",getdate()," & G_Compcode & "); select @@identity as VID ; "
         qryMain = objCommon.ExecuteScalar(qryMain)
